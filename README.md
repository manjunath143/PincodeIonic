...
===
## PinCodeIonic
A sample Ionic application demonstrating use of the CredentialsValidation Security Check.
...
3. Run the application in an Android Emulator, iOS Simulator, Browser or physical device. Press the **Get Balance** button and enter "1234" to display the balance.
